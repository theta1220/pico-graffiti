    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                if(int(IN.texcoord.x * 320 * 1.5) % 2 == 0 || int(IN.texcoord.y * 180 * 1.5) % 2 == 0 )
                {
                    float random = GetRandomNumber(IN.texcoord, _RandomSeed);
                    color.rgb = color.rgb * (0.9f + (0.1f * random));
                }
